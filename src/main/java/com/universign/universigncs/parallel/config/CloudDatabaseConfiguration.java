package com.universign.universigncs.parallel.config;
...
@Configuration
@EnableMongoRepositories("com.universign.universigncs.parallel.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.universign.universigncs.parallel.config.dbmigrations");
