...
public class Documents implements Serializable {
    ...
    public Documents documents(Set<SignatureField> signatureFields) {
        this.documents = signatureFields;
        return this;
    }

    public Documents addDocuments(SignatureField signatureField) {
        this.documents.add(signatureField);
        signatureField.setMetaTransaction(this);
        return this;
    }

    public Documents removeDocuments(SignatureField signatureField) {
    ...
    public Documents metaTransaction(MetaTransaction metaTransaction) {
