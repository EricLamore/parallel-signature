...
import { MetaTransactionParallelComponent } from 'app/entities/meta-transaction-parallel/meta-transaction-parallel.component';
...
describe('Component Tests', () => {
    describe('MetaTransactionParallel Management Component', () => {
        let comp: MetaTransactionParallelComponent;
        let fixture: ComponentFixture<MetaTransactionParallelComponent>;
        let service: MetaTransactionParallelService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [ParallelSignatureTestModule],
                declarations: [MetaTransactionParallelComponent],
                providers: [
                    {
                ...
                .overrideTemplate(MetaTransactionParallelComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(MetaTransactionParallelComponent);
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new MetaTransactionParallel('123')],
                        headers
                    })
                )
            );
